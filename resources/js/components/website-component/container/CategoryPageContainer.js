...
function CategoryPageContainer(props) {
  ...
  const data = props.pageData.categoryPage;
                ...
                <div id="myTabContent" className="tab-content category-list">
                  <div className="tab-pane active" id="grid-container">
                    <div className="category-product">                   
                      <div className="row">
                      {data.map((catpage,index) =>
                        <div className="col-sm-6 col-md-4 wow fadeInUp">
                          <div className="products">
                            <div className="product">
                              <div className="product-image">
                                <div className="image"><a href="detail.html"><img src={axios.defaults.baseURL+'admin/'+catpage.product_image}  alt="" /></a></div>
                                <div className="tag new"><span>new</span></div>
                              </div>
                              <div className="product-info text-left">
                                <h3 className="name"><a href="detail.html">{catpage.product_title}</a></h3>
                                <div className="rating rateit-small" />
                                <div className="description" />
                                <div className="product-price"><span className="price">{catpage.selling_price}</span> <span className="price-before-discount">{catpage.mrp}</span></div>
                              </div>
