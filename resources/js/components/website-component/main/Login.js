                            ...
                            <div className="col-md-6 col-sm-6 sign-in">
                                ...
                                <form className="register-form outer-top-xs" role="form" onSubmit={ e => onSubmit(e)}>
                                    <div className="form-group">
                                        ...
                                        <input type="email" name="email" className="form-control unicase-form-control text-input" id="exampleInputEmail1" name="email" value={email} onChange={e=>onInputChange(e)} />
                                    </div>
                                    <div className="form-group">
                                        <label className="info-title" htmlFor="exampleInputPassword1">Password <span>*</span></label>
                                        <input type="password" name="password" className="form-control unicase-form-control text-input" id="exampleInputPassword1" name="password" value={password} onChange={e=>onInputChange(e)} />
                                    </div>
